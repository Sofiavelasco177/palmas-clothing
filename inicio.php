    ...
    <div id="carouselExample" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="imagenes/carrusel/wb pets.png" class="d-block w-100" alt="oferta especial">
            </div>
            <div class="carousel-item">
                <img src="imagenes/carrusel/2.png" class="d-block w-100" alt="nuevos productos">
            </div>
            <div class="carousel-item">
                <img src="imagenes/carrusel/3.png" class="d-block w-100" alt="servicio destacado">
            </div>
        </div>
